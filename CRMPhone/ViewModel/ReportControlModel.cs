                            ...
                            root.AddFirst(
                                new XElement("Record",
                                    new[]
                                    {
                                        ...
                                        new XElement("ДатаЗвонка", record.CreateTime),
                                        new XElement("ДатаОтвета", record.AnswerTime),
                                        new XElement("ДатаОкончания", record.EndTime),
                                        new XElement("Ожидание", record.WaitSec),
                                        new XElement("Продолжительность", record.CallTime),
                                        new XElement("Описание", record.Result),
                                    }));
                        }
                        var saver = new FileStream(fileName, FileMode.Create);
                        root.Save(saver);
