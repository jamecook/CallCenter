...
namespace CRMPhone.ViewModel.Admins
{
    public class WorkerAdminDialogViewModel : INotifyPropertyChanged
    {
        ...
        private void ChangeParentWorkerList(ServiceCompanyDto serviceCompany)
        {
            ...
            ParentWorkerList.Add(new WorkerDto(){Id= 0, SurName = "Ќет руководител€" });
        ...
        private void AttachWorkerBinding(object obj)
        {
            ...
            {
                MessageBox.Show(_view, "ћожно прив€зывать только предварительно сохранив исполнител€!(—охраните, закройте и войдите повторно в это окно)");
                return;
            }
        ...
        private void BindCompany(object obj)
        {
            if (!_workerId.HasValue)
            {
                MessageBox.Show(_view, "јдреса можно прив€зывать только предварительно сохранив исполнител€!(—охраните, закройте и войдите повторно в это окно)");
                return;
            }
        ...
        private void Save(object sender)
        {
            ...
            {
                MessageBox.Show("Ќеобходимо заполнить ” , фамилию и специальность!");
            }
        }
